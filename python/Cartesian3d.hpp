...
void add3d_A4_ddot_B2(M& module)
{
    module.def(
        "A4_ddot_B2",
        py::overload_cast<const T&, const R&>(&GMatTensor::Cartesian3d::A4_ddot_B2<T, R>),
...
void add3d_A4_dot_B2(M& module)
{
    module.def(
        "A4_dot_B2",
        py::overload_cast<const R&, const T&>(&GMatTensor::Cartesian3d::A4_dot_B2<R, T>),
        "Product 'A . B' for two (arrays of) 4th and 2nd-order tensors.",
        py::arg("A"),
        py::arg("B"));
}
...
void init_Cartesian3d(py::module& m)
{
    ...
    add3d_Deviatoric<xt::pytensor<double, 4>>(m);
    add3d_Deviatoric<xt::pytensor<double, 3>>(m);
    add3d_Deviatoric<xt::pytensor<double, 2>>(m);
    add3d_Sym<xt::pytensor<double, 4>>(m);
    add3d_Sym<xt::pytensor<double, 3>>(m);
    add3d_Sym<xt::pytensor<double, 2>>(m);
    add3d_Inv<xt::pytensor<double, 4>>(m);
    add3d_Inv<xt::pytensor<double, 3>>(m);
    add3d_Inv<xt::pytensor<double, 2>>(m);
    add3d_Logs<xt::pytensor<double, 4>>(m);
    add3d_Logs<xt::pytensor<double, 3>>(m);
    add3d_Logs<xt::pytensor<double, 2>>(m);
    add3d_A2_dot_A2T<xt::pytensor<double, 4>>(m);
    add3d_A2_dot_A2T<xt::pytensor<double, 3>>(m);
    add3d_A2_dot_A2T<xt::pytensor<double, 2>>(m);
    add3d_A2_dot_B2<xt::pytensor<double, 4>>(m);
    add3d_A2_dot_B2<xt::pytensor<double, 3>>(m);
    add3d_A2_dot_B2<xt::pytensor<double, 2>>(m);
    ...
    add3d_A4_ddot_B2<xt::pytensor<double, 4>, xt::pytensor<double, 6>>(m);
    add3d_A4_ddot_B2<xt::pytensor<double, 3>, xt::pytensor<double, 5>>(m);
    add3d_A4_ddot_B2<xt::pytensor<double, 2>, xt::pytensor<double, 4>>(m);
    add3d_A4_dot_B2<xt::pytensor<double, 6>, xt::pytensor<double, 4>>(m);
    add3d_A4_dot_B2<xt::pytensor<double, 5>, xt::pytensor<double, 3>>(m);
    add3d_A4_dot_B2<xt::pytensor<double, 4>, xt::pytensor<double, 2>>(m);
